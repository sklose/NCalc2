...
namespace NCalc.Domain
{
    ...
    /// <summary>
        ...
        public override async Task VisitAsync(Function function)
        {
            ...
            // Calls external implementation
            await OnEvaluateFunctionAsync(IgnoreCase ? function.Identifier.Name.ToLower() : function.Identifier.Name, args);
        ...
        private async Task OnEvaluateFunctionAsync(string name, FunctionArgs args)
        {
            if (EvaluateFunctionAsync != null)
                await EvaluateFunctionAsync(name, args);
        }
